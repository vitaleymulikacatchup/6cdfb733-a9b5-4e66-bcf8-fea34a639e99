...
export const metadata: Metadata = {
  ...
  description: "Experience unmatched luxury at Grand Vista Hotel. Book your stay at our 5-star hotel featuring world-class amenities, fine dining, and elegant accommodations.",
  keywords: "luxury hotel, 5-star hotel, premium accommodations, fine dining, spa, business travel, vacation resort",
  openGraph: {
    title: "Grand Vista Hotel - Luxury 5-Star Accommodations",
    description: "Experience unmatched luxury at Grand Vista Hotel with world-class amenities and elegant accommodations.",
